...
## Changelogs
- **[1.5.6]**
  + Fix [#16](https://github.com/mdmush/rn-swiper/issues/16), [#36](https://github.com/mdmush/rn-swiper/issues/36), [#371](https://github.com/mdmush/rn-swiper/issues/371), [#410](https://github.com/mdmush/rn-swiper/issues/410), [#411](https://github.com/mdmush/rn-swiper/issues/411), [#422](https://github.com/mdmush/rn-swiper/issues/422), [#468](https://github.com/mdmush/rn-swiper/issues/468) Fix landscape orientation auto resize! (thanks [@ahmed3mar](https://github.com/ahmed3mar), [@timmywil](https://github.com/timmywil))
...
### [examples/components/Basic](https://github.com/mdmush/rn-swiper/blob/master/examples/components/Basic)

![](http://i.imgur.com/zrsazAG.gif=300x)

### [examples/components/Swiper](https://github.com/mdmush/rn-swiper/blob/master/examples/components/Swiper)

![](http://i.imgur.com/hP3f3oO.gif=300x)

### [examples/components/SwiperNumber](https://github.com/mdmush/rn-swiper/blob/master/examples/components/SwiperNumber)

![](http://i.imgur.com/0rqESVb.gif=300x)

### [examples/components/Phone](https://github.com/mdmush/rn-swiper/blob/master/examples/components/Phone)

![](http://i.imgur.com/c1BhjZm.gif=300x)

### [examples/components/LoadMinimal](https://github.com/mdmush/rn-swiper/blob/master/examples/components/LoadMinimal)
...
> Quick start with [examples](https://github.com/mdmush/rn-swiper/tree/master/examples/).
